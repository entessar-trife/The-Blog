        ...
        <div className="flex justify-between items-start max-lg:flex-wrap gap-8 mt-8">
          <div className="flex justify-between items-start gap-8 max-md:flex-wrap ">
            <CardComponent
              ...
              onClick={() => navigate(`/The-Blog/blog/${firstThreePosts[0].id}`)}
              aos="zoom-out-down"
            ...
            <CardComponent
              ...
              onClick={() => navigate(`/The-Blog/blog/${firstThreePosts[1].id}`)}
              aos="zoom-out-down"
          ...
          <div className="max-md:w-full">
            <CardComponent
              ...
              onClick={() => navigate(`/The-Blog/blog/${firstThreePosts[2].id}`)}
              aos="zoom-out-down"
