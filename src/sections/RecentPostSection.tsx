    ...
    <section className="px-8 xl:px-28 pt-[60px]">
      ...
      <div className="flex max-lg:flex-wrap gap-8 mt-8">
        <CardComponent
          ...
          onClick={() => navigate(`/blog/${latestFourPosts[0].id}`)}
        ...
        <div className="flex flex-col flex-wrap gap-8 w-full xl:w-[48.7%]">
          <CardComponent
            ...
            onClick={() => navigate(`/blog/${latestFourPosts[1].id}`)}
            aos="fade-left"
          ...
          <CardComponent
            ...
            onClick={() => navigate(`/blog/${latestFourPosts[2].id}`)}
            aos="fade-left"
            cardStyle="flex gap-6 flex-wrap md:flex-nowrap"
      ...
      <CardComponent
        ...
        onClick={() => navigate(`/blog/${latestFourPosts[3].id}`)}
